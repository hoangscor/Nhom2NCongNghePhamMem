!function(t, n, e) {
    ...
    9: [function(t, n, e) {
                ...
                if (e) {
                    ...
                    if (window.performance && window.performance.getEntriesByType) {
                        ...
                        a.forEach(function(t) {
                            ...
                            U(t.name, Math.floor(t.startTime)))
                        })
                    }
        ...
        function u(t, n, e, r) {
            ...
            var c = o(u, s);
            return c || o !== y.beacon || (c = y.img(i + g.obj(e.body, n.maxBytes))),
            c
        }
        function c(t) {
        ...
        function l(t) {
            var n = !0;
            return "init"in NREUM && "privacy"in NREUM.init && (n = NREUM.init.privacy.cookies_enabled),
            ["?a=" + t.info.applicationID, g.param("sa", t.info.sa ? "" + t.info.sa : ""), g.param("v", S), f(t), g.param("ct", t.customTransaction), "&rst=" + t.now(), "&ck=" + (n ? "1" : "0"), g.param("ref", E(T.getLocation()))].join("")
        }
        function h(t) {
            var n = !1;
            return function(e, r) {
        ...
        t(10);
        var A = k.ieVersion > 9 || 0 === k.ieVersion
          , U = t(16).addMetric;
        n.exports = {
            sendRUM: p(r),
            sendFinal: i,
    ...
    11: [function(t, n, e) {
        ...
        6 === t(10) ? c.maxBytes = 2e3 : c.maxBytes = 3e4,
        c.releaseIds = {},
        o(r),
        s("mark", i.mark, "api"),
        i.mark("done"),
    ...
    14: [function(t, n, e) {
        function r() {
            var t = !0;
            "init"in NREUM && "privacy"in NREUM.init && (t = NREUM.init.privacy.cookies_enabled),
            a.navCookie && t && s.setCookie()
        }
        function i() {
    ...
    24: [function(t, n, e) {
        ...
        function c(t) {
            for (var n = l(), e = "bel.6;", r = 0; r < t.length; r++) {
                var i = t[r];
                e += "e,",
                e += n(i.name) + ",",
                e += f(i.value, d, !1) + ",";
                var o = h(i.attrs, n);
                o && o.length > 0 && (e += o.length + ";" + o.join(";")),
                r + 1 < t.length && (e += ";")
            }
            return e
        }
    ...
    25: [function(t, n, e) {
        function r(t) {
            var n = o(t);
            !i || navigator.sendBeacon ? a("pagehide", n) : a("beforeunload", n),
            a("unload", n)
        }
        var i = t(38)
          , o = t(19)
    ...
    31: [function(t, n, e) {
        ...
        var o, a = t("ee"), s = t("loader"), u = t(40), c = t(22), f = t(17), d = t(9), l = t(5), h = t(12), p = 120, m = 30, v = p * m / 60, g = [], x = s.info.jsAttributes = {};
    ...
    32: [function(t, n, e) {
        ...
        function s(t, n) {
            ...
            this.handlers = [];
            var e = this.root = new u(this,null,"interaction",n)
              , r = e.attrs;
            r.trigger = t,
            r.initialPageURL = m.origin,
            r.oldRoute = Y,
            r.newURL = r.oldURL = Q,
            r.custom = {},
            r.store = {}
        ...
        function f(t) {
            return t.ignored || !t.save && !t.routeChange ? void v.emit("interactionDiscarded", [t]) : (t.root.attrs.id = C.generateUuid(),
            ...
            v.emit("interactionSaved", [t]),
            lt = p(t.root, 0, N, t.routeChange),
            void h.sendX("events", m))
        }
        var d = t(17)
          , l = t(36)
          , h = t(9)
          ...
          , C = t(39)
          , A = t(16).metrics
          , U = ["click", "submit", "keypress", "keydown", "keyup", "change"]
          , L = 128
          , _ = 999
          , M = "fn-start"
          , I = "fn-end"
        ...
        v.on("feat-spa", function() {
            ...
            function n() {
                ...
                var t = this.jsTime || 0
                  , n = t - at;
                at = this.ct + t,
                nt && (nt.callback(n, this[I]),
                this.isTraced && (nt.attrs.tracedTime = n)),
                this.jsTime = nt ? 0 : n,
                a(this.prevNode),
                this.prevNode = null,
                tt = _
            ...
            function u(t) {
                return nt && nt[F] === t ? nt : t.root
            }
            it = new s("initialPageLoad",0),
            it.save = !0,
            nt = it.root,
            it[P]++,
            d.on(v, M, t),
            ...
            d("spa-register", function(t) {
                "function" == typeof t && t(f)
            }),
            d.on(v, I, n),
            d.on(x, "cb-end", n),
            d.on(w, M, function(t, n) {
                var e = t[0]
                  , r = e.type
                  , i = e.__nrNode;
                if (ot || "load" !== r || n !== window || (ot = !0,
                this.prevNode = nt = null,
                it && (i = it.root,
                it[P]--,
                W(function() {
                    U.push("popstate")
                ...
                i)
                    ...
                    a(v.context(n).spaNode);
                else if (!nt && U.indexOf(r) !== -1) {
                    var o = new s(r,this[M]);
                    if (a(o.root),
                    "click" === r) {
                        var u = c(e.target);
                        u && (nt.attrs.custom.actionText = u)
                    }
                }
                e.__nrNode = nt
            }),
            d.on(b, "setTimeout-end", function(t, n, e) {
                !nt || tt - this.timerDuration < 0 || (nt[F][P]++,
                this.timerId = e,
                Z[e] = nt,
                this.timerBudget = tt - 50)
            }),
            d.on(b, "clearTimeout-start", function(t) {
                var n = t[0]
                  , e = Z[n];
                if (e) {
                    var r = e[F];
            ...
            d.on(T, "new-xhr", function() {
                nt && (this[O] = nt.child("ajax", null, null, !0))
            }),
            d.on(T, "send-xhr-start", function() {
                var t = this[O];
            ...
            d.on(k, "new-jsonp", function(t) {
                if (nt) {
                    var n = this[H] = nt.child("ajax", this[$]);
                    n.start = this["new-jsonp"],
                    this.url = t,
                    this.status = null
                }
            }),
            d.on(k, "cb-start", function(t) {
                var n = this[H];
                n && (a(n),
                this.status = 200)
            }),
            d.on(k, "jsonp-error", function() {
                var t = this[H];
                t && (a(t),
                this.status = 0)
            }),
            ...
            d.on(j, $, function(t, n) {
                nt && t && (this[O] = nt.child("ajax", this[$]),
                t.length >= 1 && (this.target = t[0]),
                t.length >= 2 && (this.opts = t[1]),
                n && (this[O].dt = n))
            }),
            d.on(j, z + "start", function(t) {
                nt && (this[O] = nt,
                nt[F][P]++)
            }),
            d.on(j, z + "end", function(t, n, e) {
                var r = this[O];
                r && r[F][P]--
            }),
            d.on(j, V, function(t, n) {
                var e = this[O]
                  , r = this.target
                  , i = this.opts || {};
                if (e) {
                    if (t)
                        ...
                        void e[F][P]--;
                    var o, a;
                    "string" == typeof r ? o = r : "object" == typeof r && r instanceof K && (o = r.url),
            ...
            d.on(y, "newURL", function(t, n) {
                nt && (Q !== t && (nt[F].routeChange = !0),
                n && (rt = nt)),
                Q = t
            }),
            k.on("dom-start", function(t) {
                function n() {
                    o[P]--,
                    o.checkFinish()
                }
                ...
                if (nt) {
                    ...
                    r.addEventListener("error", e, !1))
                }
            }),
            d.on(g, M, function() {
                a(et)
            }),
            d.on(x, "resolve-start", i),
            d.on(x, "executor-err", i),
            d.on(x, "propagate", r),
            d.on(x, q, function() {
            ...
            d(B + "get", function(t) {
                var n = this.ixn = nt ? nt[F] : new s("api",t);
                nt || (n.checkFinish(),
                st && a(n.root))
            }),
            d(B + "actionText", function(t, n) {
                var e = this.ixn.root.attrs.custom;
                n && (e.actionText = n)
            }),
            d(B + "setName", function(t, n, e) {
                var r = this.ixn.root.attrs;
                n && (r.customName = n),
                e && (r.trigger = e)
            }),
            d(B + "setAttribute", function(t, n, e) {
            ...
            d(B + "tracer", function(t, n, e) {
                var r = this.ixn
                  , i = u(r)
                  , o = v.context(e);
                return n ? void (o[O] = i.child("customTracer", t, n)) : (o.inc = ++r[P],
                o[O] = i)
            }),
            d.on(E, M, e),
            d.on(E, "no-" + M, e),
            d(B + "getContext", function(t, n) {
                var e = this.ixn.root.attrs.store;
                setTimeout(function() {
                    n(e)
                }, 0)
            }),
            d(B + "onEnd", function(t, n) {
                this.ixn.handlers.push(n)
            }),
            d("api-routeName", function(t, n) {
                Y = n
            })
        });
        var ft = s.prototype;
        ft.checkFinish = function() {
            var t = this
              , n = this.root.attrs;
            t.finishTimer && (G(t.finishTimer),
            t.finishTimer = null),
            t[P] || (n.newURL = Q,
            n.newRoute = Y,
            t.finishTimer = W(function() {
                t.finishTimer = W(function() {
                    t.finishTimer = null,
                    t[P] || t.finish()
                }, 1)
        ...
        ft.finish = function() {
            ...
            if (!n.end) {
                ...
                var e = Math.max(t.lastCb, t.lastFinish)
                  ...
                  , i = r.custom;
                nt = n,
                S(this.handlers, function(t, n) {
                    n(r.store)
                }),
                a(null),
                S(m.info.jsAttributes, function(t, n) {
                    t in i || (i[t] = n)
                }),
                n.end = e,
                v.emit("interaction", [this]),
                ct.indexOf(this) >= 0 && ct.splice(ct.indexOf(this), 1)
            }
        }
        ;
        var dt = u.prototype;
        dt.child = function(t, n, e, r) {
            var i = this[F];
            if (i.end || i.nodes >= L)
                return null;
            i.finishTimer && (G(i.finishTimer),
            i.finishTimer = null);
            var o = new u(i,this,t,n);
        ...
        v.on("errorAgg", function(t, n, e, r) {
            nt && (e._interactionId = nt.interaction.id,
            nt.type && "interaction" !== nt.type && (e._interactionNodeId = nt.id))
        }),
        v.on("interaction", f)
    }
    , {}],
        ...
        function r(t, n, e, r) {
            function d(t, c) {
                ...
                var g = t.type
                  ...
                  , N = E.params
                  , R = o.info.queueTime
                  , C = o.info.applicationTime;
                "undefined" == typeof h ? (y += n,
                h = y) : y -= h;
                var A = [u(y), u(t.end - t.start), u(t.jsEnd - t.end), u(t.jsTime)];
                switch (x) {
                case 1:
                    A[2] = u(t.jsEnd - h),
                    A.push(l(E.trigger), l(i(E.initialPageURL, v)), l(i(E.oldURL, v)), l(i(E.newURL, v)), l(E.customName), p ? "" : r ? 1 : 2, s(p && R, u, !0) + s(p && C, u, !0) + s(E.oldRoute, l, !0) + s(E.newRoute, l, !0) + l(E.id), l(t.id), s(E.firstPaint, u, !0) + s(E.firstContentfulPaint, u, !1));
                    var U = f(E.custom, l);
                    T = T.concat(U),
                    b = U.length,
                    j && (w++,
                    ...
                    break;
                case 2:
                    A.push(l(N.method), u(N.status), l(N.host), l(N.pathname), u(S.txSize), u(S.rxSize), E.isFetch ? 1 : E.isJSONP ? 2 : "", l(t.id), s(t.dt && t.dt.guid, l, !0) + s(t.dt && t.dt.traceId, l, !0) + s(t.dt && t.dt.timestamp, u, !1));
                    break;
                case 4:
                    var L = E.tracedTime;
                    A.push(l(E.name), s(L, u, !0) + l(t.id))
                }
                for (var _ = 0; _ < t.children.length; _++)
                    d(t.children[_], T);
                if (A.unshift(u(x), u(w += b)),
                c.push(A),
                w && c.push(T.join(";")),
                k) {
                    var M = ","
            ...
            var l = c();
            n = n || 0;
            var h, p = "initialPageLoad" === t.attrs.trigger, m = {
                interaction: 1,
                ajax: 2,
                customTracer: 4
            }, v = !0;
            return "bel.7;" + d(t, []).join(";")
        }
        var i = t(5)
          , o = t("loader")
          , a = t(40)
          , s = t(4).nullable
          , u = t(4).numeric
          , c = t(4).getAddStringContext
          , f = t(4).addCustomAttributes;
        n.exports = r
    }
    , {}],
    34: [function(t, n, e) {
        ...
        function p() {
            ...
            var t = T(k(_, function(t, n) {
                return t in U ? T(k(T(n.sort(m), v(t), {}), g), x, []) : n
            }), x, []);
            if (0 === t.length)
                return {};
            _ = {};
        ...
        if (j.xhrUsable && w.xhrWrappable) {
            ...
            w.features.stn) {
                M.on("feat-stn", function() {
                    ...
                    R(function() {
                        var t = 0;
                        return w.now() > 9e5 ? void (_ = {}) : (k(_, function(n, e) {
    ...
    36: [function(t, n, e) {
        ...
        n.exports = function(t) {
            ...
            i.hostname = n.hostname || e.hostname,
            ...
            return i.sameOrigin = a && (!n.hostname || s),
            "/" === i.pathname && (r[t] = i),
            i
        }
    }
